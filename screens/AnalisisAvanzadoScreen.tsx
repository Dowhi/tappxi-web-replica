                        ...
                        <div className="bg-zinc-900 rounded-xl p-4 border border-zinc-800">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-4">
                                ...
                                <div className="bg-zinc-800 rounded-lg p-3">
                                    ...
                                    <div className="text-white text-lg font-bold">{(mesAnterior.ingresos ?? 0).toFixed(2)}€</div>
                                    <div className="text-zinc-500 text-xs mt-1">Gastos: {(mesAnterior.gastos ?? 0).toFixed(2)}€</div>
                                </div>
                            </div>
                            <div className="bg-zinc-800 rounded-lg p-3">
                        ...
                        <div className="bg-zinc-900 rounded-xl p-4 border border-zinc-800">
                            ...
                            <div className="grid grid-cols-2 gap-3 mb-4">
                                ...
                                <div className="bg-zinc-800 rounded-lg p-3">
                                    ...
                                    <div className="text-white text-lg font-bold">{(añoAnterior.ingresos ?? 0).toFixed(2)}€</div>
                                    <div className="text-zinc-500 text-xs mt-1">Gastos: {(añoAnterior.gastos ?? 0).toFixed(2)}€</div>
                                </div>
                            </div>
                            <div className="bg-zinc-800 rounded-lg p-3">
                                <div className="text-zinc-400 text-xs mb-2">Diferencia</div>
                        ...
                        <div className="bg-zinc-900 rounded-xl p-4 border border-zinc-800">
                            ...
                            <div className="space-y-3">
                                <div className="bg-zinc-800 rounded-lg p-3">
                                    ...
                                    <div className="text-white text-lg font-bold">{(objetivoDiario ?? 0).toFixed(2)}€</div>
                                </div>
                                <div className="bg-zinc-800 rounded-lg p-3">
                                    <div className="text-zinc-400 text-xs mb-1">Objetivo Mensual</div>
                                    <div className="text-white text-lg font-bold">{(metasVsLogros.objetivoMensual ?? 0).toFixed(2)}€</div>
                                </div>
                                <div className="bg-zinc-800 rounded-lg p-3">
                                    <div className="text-zinc-400 text-xs mb-1">Ingresos Hasta Ahora</div>
                                    <div className="text-white text-lg font-bold">{(metasVsLogros.ingresosHastaAhora ?? 0).toFixed(2)}€</div>
                                    <div className="text-zinc-500 text-xs mt-1">
                                        Objetivo hasta ahora: {(metasVsLogros.objetivoHastaAhora ?? 0).toFixed(2)}€
                                    </div>
                                </div>
                                <div className={`rounded-lg p-3 ${metasVsLogros.porcentajeCumplimiento >= 100 ? 'bg-green-900/30 border border-green-500/50' : 'bg-zinc-800'}`}>
                                    ...
                                    <div className={`text-2xl font-bold ${metasVsLogros.porcentajeCumplimiento >= 100 ? 'text-green-400' : 'text-white'}`}>
                                        {(metasVsLogros.porcentajeCumplimiento ?? 0).toFixed(1)}%
                                    </div>
                                    <div className={`text-sm mt-2 ${metasVsLogros.diferencia >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                                        {metasVsLogros.diferencia >= 0 ? '+' : ''}{(metasVsLogros.diferencia ?? 0).toFixed(2)}€
                                    </div>
                                </div>
                                <div className="bg-zinc-800 rounded-lg p-3">
                                    <div className="text-zinc-400 text-xs mb-1">Proyección Mensual</div>
                                    <div className="text-white text-lg font-bold">{(metasVsLogros.proyeccionMensual ?? 0).toFixed(2)}€</div>
                                    <div className="text-zinc-500 text-xs mt-1">
