...
const processBizumIcon = async () => {
    const sourcePath = path.join(publicDir, 'bizum-icon.png');
    const outputPath = path.join(publicDir, 'bizum-icon.png');
    ...
    console.log(`✅ Cropped and saved Bizum icon`);
};

processBizumIcon().catch(err => {
